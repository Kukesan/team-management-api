    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportAchievements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReportAchievements_Reports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportBlockers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReportBlockers_Reports_ReportId",
                        column: x => x.ReportId,
                        principalTable: "Reports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ReportHoursBreakdowns",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ReportId = table.Column<Guid>(type: "uuid", nullable: false),
                    TaskType = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    Hours = table.Column<decimal>(type: "numeric(6,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportHoursBreakdowns", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReportHoursBreakdowns_Reports_ReportId",
                        column: x => x.ReportId,
                        principalTable: "Reports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlannedPercent = table.Column<int>(type: "integer", nullable: false),
                    ActualPercent = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    TimePlannedHours = table.Column<decimal>(type: "numeric(6,2)", nullable: false),
                    TimeSpentHours = table.Column<decimal>(type: "numeric(6,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportTaskItems_Reports_ReportId",
                        column: x => x.ReportId,
                        principalTable: "Reports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportReviews_AspNetUsers_ReviewerId",
                        column: x => x.ReviewerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReportReviews_ReportVersions_ReportVersionId",
                        column: x => x.ReportVersionId,
                        principalTable: "ReportVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReportReviews_Reports_ReportId",
                        column: x => x.ReportId,
                        principalTable: "Reports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportAchievements_ReportId",
                table: "ReportAchievements",
                column: "ReportId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportBlockers_ReportId",
                table: "ReportBlockers",
                column: "ReportId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportHoursBreakdowns_ReportId",
                table: "ReportHoursBreakdowns",
                column: "ReportId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportReviews_ReportId",
                table: "ReportReviews",
                column: "ReportId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportReviews_ReportVersionId",
                table: "ReportReviews",
                column: "ReportVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportReviews_ReviewerId",
                table: "ReportReviews",
                column: "ReviewerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportTaskItems_ReportId",
